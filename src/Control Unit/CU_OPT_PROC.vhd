...
BEGIN
  ...
  BEGIN
    ...
    ELSE
      -- Decode Stage Signals
      IF is_iadd OR (is_group_10 AND sub_bits(2) = '1') OR 
    ...
    --//////////////////////////////////////////////////////
      ...
      IF is_iadd OR (is_group_10 AND sub_bits(2) = '1') THEN
        ALU_SRC <= "10";
      ...
      IF is_group_00 AND sub_bits = "011" THEN
        ALU_OP <= "101"; -- NOT
      ELSIF (is_group_01 AND sub_bits = "000") OR (OP_CODE = "10000") THEN
      ...
      ELSIF is_group_01 AND sub_bits = "100" THEN
        ALU_OP <= "100"; -- AND
      ELSIF (is_group_01 AND sub_bits = "010") OR is_iadd OR (OP_CODE = "00100") THEN
      ...
      -- Write Back Address
      IF OP_CODE = "10011" OR (is_group_10 AND (sub_bits = "000" OR sub_bits = "001" OR sub_bits = "101")) THEN
        WB_ADDR <= "01";
      ELSIF is_group_10 AND (sub_bits = "010" OR sub_bits = "011" OR sub_bits = "100") THEN
        WB_ADDR <= "10";
      ELSE
        WB_ADDR <= "00";
      END IF;
