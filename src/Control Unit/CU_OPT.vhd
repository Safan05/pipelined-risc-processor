...
--//////////////////////////////////////////////////////
  ...
  -- Stack Pointer: RTI(11), RET/POP(10), PUSH/CALL/INT(01)
  SP_OP     <= "11" WHEN OP_CODE = "11011" ELSE -- RTI
               "10" WHEN OP_CODE = "11001" OR OP_CODE = "10001" ELSE -- RET, POP
               "01" WHEN OP_CODE = "10000" OR OP_CODE = "11000" OR OP_CODE = "11010" ELSE -- PUSH, CALL, INT
               "00";

  -- # Memory Stage
  PC_SEL      <= '1' WHEN is_ret_rti ELSE '0'; -- RET, RTI
  ...
  MEM_ADDR    <= "10" WHEN is_group_11 OR (is_group_10 AND sub_bits(1 downto 0) /= "10" AND sub_bits(1 downto 0) /= "11") ELSE
                 "01" WHEN OP_CODE = "10011" OR OP_CODE = "10100" ELSE -- LDD, STD
                 "00";

  -- Write Data: INT(10), PUSH/STD(01), CALL(00)
  MEM_WRT_DATA <= "10" WHEN OP_CODE = "11010" ELSE
                  "01" WHEN OP_CODE = "10000" OR OP_CODE = "10100" ELSE
                  "00";

  -- # Write Back Stage
  -- Data: MOV/SWAP(11), LDM(10), ALU/IN(01), LDD/POP(00)
  WB_DATA     <= "11" WHEN is_group_01 AND (sub_bits = "000" OR sub_bits = "001") ELSE -- MOV, SWAP
                 "10" WHEN OP_CODE = "10010" ELSE -- LDM
                 "01" WHEN is_group_01 OR OP_CODE="00011" OR OP_CODE="00100" OR OP_CODE="00110" ELSE -- ALU, NOT, INC, IN
                 "00";
  ...
  SWAP_SIG    <= '1' WHEN OP_CODE = "01001" ELSE '0';
