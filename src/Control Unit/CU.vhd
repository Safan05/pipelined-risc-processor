...
ARCHITECTURE RTL OF CU IS
  ...
  -- Internal signal for RD_NXT_INST
  SIGNAL RD_NXT_INST : STD_LOGIC;

  -- Internal OP_CODE that gets gated
  SIGNAL OP_CODE : STD_LOGIC_VECTOR(4 DOWNTO 0);

BEGIN

  -- When RD_NXT_INST = '0', OP_CODE becomes "00000"
  -- When RD_NXT_INST = '1', OP_CODE equals OP_CODE_IN
  OP_CODE <= OP_CODE_IN WHEN RD_NXT_INST = '1' ELSE "00000";
